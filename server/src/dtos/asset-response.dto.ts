...
import z from 'zod';
import type { MaybeDehydrated, VideoStreamInfo } from 'src/types.js';
...
import { LibraryAssetResponseSchema, mapLibraryAsset } from 'src/dtos/library.dto.js';
...
export const VideoStreamInfoResponseSchema = z
  .object({
    ...
    rotation: z.int().describe('Video rotation angle'),
    codecName: z.string().nullish().describe('Codec name'),
    profile: z.int().nullish().describe('Profile'),
    level: z.int().nullish().describe('Level'),
    frameCount: z.int().describe('Frame count'),
    frameRate: z.number().meta({ format: 'double' }).nullish().describe('Frame rate'),
    timeBase: z.int().nullish().describe('Time base den'),
    bitrate: z.int().describe('Bitrate'),
    pixelFormat: z.string().describe('Pixel format'),
    colorPrimaries: z.int().describe('Color primaries'),
    colorMatrix: z.int().describe('Color matrix'),
    colorTransfer: z.int().describe('Color transfer'),
