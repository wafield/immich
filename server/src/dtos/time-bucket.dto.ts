...
const TimeBucketQueryBaseSchema = z
  .object({
    ...
    isScreenshot: stringToBool
      .optional()
      .describe('Filter by screenshot status (true for screenshots only, false for non-screenshots only)'),
...
const TimeBucketAssetResponseSchema = z
  .object({
    ...
    isNotInAnyAlbum: z
      .array(z.boolean())
      .describe('Array indicating whether each asset is not part of any album'),
    ...
    deletedAt: z
      .array(z.string().nullable())
      .optional()
      .describe('Array of UTC timestamps when each asset was moved to trash'),
    ...
    model: z.array(z.string().nullable()).optional().describe('Array of camera model strings extracted from EXIF data'),
    ...
    dateTimeOriginal: z
      .array(z.string().nullable())
      .optional()
      .describe('Array of original date taken timestamps extracted from EXIF data'),
    description: z
      .array(z.string().nullable())
      .optional()
