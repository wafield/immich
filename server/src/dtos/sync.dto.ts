...
const SyncAssetExifV1Schema = z
  .object({
    ...
    actionsDescription: z.string().nullable().describe('Actions description'),
    actionsSoftwareAgentName: z.string().nullable().describe('Actions software agent name'),
    afAreaMode: z.string().nullable().describe('AF area mode'),
    afAreaModeSetting: z.string().nullable().describe('AF area mode setting'),
    afMode: z.string().nullable().describe('AF mode'),
    afPointPosition: z.string().nullable().describe('AF point position'),
    afSubjectDetection: z.string().nullable().describe('AF subject detection'),
    ambientTemperature: z.string().nullable().describe('Ambient temperature'),
    autoISO: z.string().nullable().describe('Auto ISO'),
    brightness: z.string().nullable().describe('Brightness'),
    cameraTemperature: z.string().nullable().describe('Camera temperature'),
    cameraType: z.string().nullable().describe('Camera type'),
    canonExposureMode: z.string().nullable().describe('Canon exposure mode'),
    claimGeneratorInfoName: z.string().nullable().describe('Claim generator info name'),
    clarity: z.string().nullable().describe('Clarity'),
    colorChromeEffect: z.string().nullable().describe('Color chrome effect'),
    colorChromeFXBlue: z.string().nullable().describe('Color chrome FX blue'),
    colorTempKelvin: z.string().nullable().describe('Color temperature in Kelvin'),
    colorTemperature: z.string().nullable().describe('Color temperature'),
    colorTone: z.string().nullable().describe('Color tone'),
    continuousDrive: z.string().nullable().describe('Continuous drive mode'),
    contrast: z.string().nullable().describe('Contrast'),
    creatorTool: z.string().nullable().describe('Creator tool'),
    customRendered: z.string().nullable().describe('Custom rendered'),
    developmentDynamicRange: z.string().nullable().describe('Development dynamic range'),
    driveMode: z.string().nullable().describe('Drive mode'),
    dynamicRange: z.string().nullable().describe('Dynamic range'),
    electronicFrontCurtainShutter: z.string().nullable().describe('Electronic front curtain shutter'),
    exifVersion: z.string().nullable().describe('EXIF version'),
    exposureCompensation: z.string().nullable().describe('Exposure compensation'),
    exposureMode: z.string().nullable().describe('Exposure mode'),
    exposureProgram: z.string().nullable().describe('Exposure program'),
    facesDetected: z.string().nullable().describe('Faces detected'),
    fade: z.string().nullable().describe('Fade'),
    fileFormat: z.string().nullable().describe('File format'),
    filmMode: z.string().nullable().describe('Film mode'),
    flash: z.string().nullable().describe('Flash'),
    flashAction: z.string().nullable().describe('Flash action'),
    focusLocation: z.string().nullable().describe('Focus location'),
    focusMode: z.string().nullable().describe('Focus mode'),
    focusMode2: z.string().nullable().describe('Focus mode 2'),
    focusPixel: z.string().nullable().describe('Focus pixel'),
    grainEffectRoughness: z.string().nullable().describe('Grain effect roughness'),
    grainEffectSize: z.string().nullable().describe('Grain effect size'),
    highlightTone: z.string().nullable().describe('Highlight tone'),
    highlights: z.string().nullable().describe('Highlights'),
    historySoftwareAgent: z.string().nullable().describe('History software agent'),
    imageQuality: z.string().nullable().describe('Image quality'),
    imageStabilization: z.string().nullable().describe('Image stabilization'),
    jpegQuality: z.string().nullable().describe('JPEG quality'),
    lut1Name: z.string().nullable().describe('LUT 1 name'),
    lut1Opacity: z.string().nullable().describe('LUT 1 opacity'),
    lut2Name: z.string().nullable().describe('LUT 2 name'),
    lut2Opacity: z.string().nullable().describe('LUT 2 opacity'),
    meteringMode: z.string().nullable().describe('Metering mode'),
    monochromeGrainEffect: z.string().nullable().describe('Monochrome grain effect'),
    mpImageLength: z.string().nullable().describe('MP image length'),
    noiseReduction: z.string().nullable().describe('Noise reduction'),
    numberOfImages: z.string().nullable().describe('Number of images'),
    pictureEffect: z.string().nullable().describe('Picture effect'),
    pictureMode: z.string().nullable().describe('Picture mode'),
    pictureStyle: z.string().nullable().describe('Picture style'),
    pitchAngle: z.string().nullable().describe('Pitch angle'),
    quality: z.string().nullable().describe('Quality'),
    releaseMode: z.string().nullable().describe('Release mode'),
    rollAngle: z.string().nullable().describe('Roll angle'),
    saturation: z.string().nullable().describe('Saturation'),
    sceneCaptureType: z.string().nullable().describe('Scene capture type'),
    sensitivityType: z.string().nullable().describe('Sensitivity type'),
    shadowTone: z.string().nullable().describe('Shadow tone'),
    shadows: z.string().nullable().describe('Shadows'),
    sharpness: z.string().nullable().describe('Sharpness'),
    sharpnessRange: z.string().nullable().describe('Sharpness range'),
    shootingMode: z.string().nullable().describe('Shooting mode'),
    shutter: z.string().nullable().describe('Shutter'),
    shutterType: z.string().nullable().describe('Shutter type'),
    software: z.string().nullable().describe('Software'),
    userComment: z.string().nullable().describe('User comment'),
    wbShiftAB: z.string().nullable().describe('White balance shift AB'),
    wbShiftGM: z.string().nullable().describe('White balance shift GM'),
    whiteBalance: z.string().nullable().describe('White balance'),
    whiteBalanceFineTune: z.string().nullable().describe('White balance fine tune'),
  })
