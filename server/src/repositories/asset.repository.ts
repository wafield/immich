            ...
            ...removeUndefinedKeys(
              {
                ...
                actionsDescription: ref('actionsDescription'),
                actionsSoftwareAgentName: ref('actionsSoftwareAgentName'),
                afAreaMode: ref('afAreaMode'),
                afAreaModeSetting: ref('afAreaModeSetting'),
                afMode: ref('afMode'),
                afPointPosition: ref('afPointPosition'),
                afSubjectDetection: ref('afSubjectDetection'),
                ambientTemperature: ref('ambientTemperature'),
                autoISO: ref('autoISO'),
                brightness: ref('brightness'),
                cameraTemperature: ref('cameraTemperature'),
                cameraType: ref('cameraType'),
                canonExposureMode: ref('canonExposureMode'),
                claimGeneratorInfoName: ref('claimGeneratorInfoName'),
                clarity: ref('clarity'),
                colorChromeEffect: ref('colorChromeEffect'),
                colorChromeFXBlue: ref('colorChromeFXBlue'),
                colorTempKelvin: ref('colorTempKelvin'),
                colorTemperature: ref('colorTemperature'),
                colorTone: ref('colorTone'),
                continuousDrive: ref('continuousDrive'),
                contrast: ref('contrast'),
                creatorTool: ref('creatorTool'),
                customRendered: ref('customRendered'),
                developmentDynamicRange: ref('developmentDynamicRange'),
                driveMode: ref('driveMode'),
                dynamicRange: ref('dynamicRange'),
                electronicFrontCurtainShutter: ref('electronicFrontCurtainShutter'),
                exifVersion: ref('exifVersion'),
                exposureCompensation: ref('exposureCompensation'),
                exposureMode: ref('exposureMode'),
                exposureProgram: ref('exposureProgram'),
                facesDetected: ref('facesDetected'),
                fade: ref('fade'),
                fileFormat: ref('fileFormat'),
                filmMode: ref('filmMode'),
                flash: ref('flash'),
                flashAction: ref('flashAction'),
                focusLocation: ref('focusLocation'),
                focusMode: ref('focusMode'),
                focusMode2: ref('focusMode2'),
                focusPixel: ref('focusPixel'),
                grainEffectRoughness: ref('grainEffectRoughness'),
                grainEffectSize: ref('grainEffectSize'),
                highlightTone: ref('highlightTone'),
                highlights: ref('highlights'),
                historySoftwareAgent: ref('historySoftwareAgent'),
                imageQuality: ref('imageQuality'),
                imageStabilization: ref('imageStabilization'),
                jpegQuality: ref('jpegQuality'),
                lut1Name: ref('lut1Name'),
                lut1Opacity: ref('lut1Opacity'),
                lut2Name: ref('lut2Name'),
                lut2Opacity: ref('lut2Opacity'),
                meteringMode: ref('meteringMode'),
                monochromeGrainEffect: ref('monochromeGrainEffect'),
                mpImageLength: ref('mpImageLength'),
                noiseReduction: ref('noiseReduction'),
                numberOfImages: ref('numberOfImages'),
                pictureEffect: ref('pictureEffect'),
                pictureMode: ref('pictureMode'),
                pictureStyle: ref('pictureStyle'),
                pitchAngle: ref('pitchAngle'),
                quality: ref('quality'),
                releaseMode: ref('releaseMode'),
                rollAngle: ref('rollAngle'),
                saturation: ref('saturation'),
                sceneCaptureType: ref('sceneCaptureType'),
                sensitivityType: ref('sensitivityType'),
                shadowTone: ref('shadowTone'),
                shadows: ref('shadows'),
                sharpness: ref('sharpness'),
                sharpnessRange: ref('sharpnessRange'),
                shootingMode: ref('shootingMode'),
                shutter: ref('shutter'),
                shutterType: ref('shutterType'),
                software: ref('software'),
                userComment: ref('userComment'),
                wbShiftAB: ref('wbShiftAB'),
                wbShiftGM: ref('wbShiftGM'),
                whiteBalance: ref('whiteBalance'),
                whiteBalanceFineTune: ref('whiteBalanceFineTune'),
                lockedProperties:
                  lockedPropertiesBehavior === 'append'
