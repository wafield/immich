  ...
  async writeExif(tags: Partial<Exif>, output: string): Promise<boolean> {
    try {
      const tagsToWrite: any = {
        ...
        ActionsDescription: tags.actionsDescription ?? undefined,
        ActionsSoftwareAgentName: tags.actionsSoftwareAgentName ?? undefined,
        AFAreaMode: tags.afAreaMode ?? undefined,
        AFAreaModeSetting: tags.afAreaModeSetting ?? undefined,
        AFMode: tags.afMode ?? undefined,
        AFPointPosition: tags.afPointPosition ?? undefined,
        AFSubjectDetection: tags.afSubjectDetection ?? undefined,
        AmbientTemperature: tags.ambientTemperature ?? undefined,
        AutoISO: tags.autoISO ?? undefined,
        Brightness: tags.brightness ?? undefined,
        CameraType: tags.cameraType ?? undefined,
        CanonExposureMode: tags.canonExposureMode ?? undefined,
        Claim_Generator_InfoName: tags.claimGeneratorInfoName ?? undefined,
        Clarity: tags.clarity ?? undefined,
        ColorChromeEffect: tags.colorChromeEffect ?? undefined,
        ColorChromeFXBlue: tags.colorChromeFXBlue ?? undefined,
        ColorTempKelvin: tags.colorTempKelvin ?? undefined,
        ColorTemperature: tags.colorTemperature ?? undefined,
        ColorTone: tags.colorTone ?? undefined,
        ContinuousDrive: tags.continuousDrive ?? undefined,
        Contrast: tags.contrast ?? undefined,
        CreatorTool: tags.creatorTool ?? undefined,
        CustomRendered: tags.customRendered ?? undefined,
        DevelopmentDynamicRange: tags.developmentDynamicRange ?? undefined,
        DriveMode: tags.driveMode ?? undefined,
        DynamicRange: tags.dynamicRange ?? undefined,
        ElectronicFrontCurtainShutter: tags.electronicFrontCurtainShutter ?? undefined,
        ExifVersion: tags.exifVersion ?? undefined,
        ExposureCompensation: tags.exposureCompensation ?? undefined,
        ExposureMode: tags.exposureMode ?? undefined,
        ExposureProgram: tags.exposureProgram ?? undefined,
        FacesDetected: tags.facesDetected ?? undefined,
        Fade: tags.fade ?? undefined,
        FileFormat: tags.fileFormat ?? undefined,
        FilmMode: tags.filmMode ?? undefined,
        Flash: tags.flash ?? undefined,
        FlashAction: tags.flashAction ?? undefined,
        FocusLocation: tags.focusLocation ?? undefined,
        FocusMode: tags.focusMode ?? undefined,
        FocusMode2: tags.focusMode2 ?? undefined,
        FocusPixel: tags.focusPixel ?? undefined,
        GrainEffectRoughness: tags.grainEffectRoughness ?? undefined,
        GrainEffectSize: tags.grainEffectSize ?? undefined,
        HighlightTone: tags.highlightTone ?? undefined,
        Highlights: tags.highlights ?? undefined,
        HistorySoftwareAgent: tags.historySoftwareAgent ?? undefined,
        ImageQuality: tags.imageQuality ?? undefined,
        ImageStabilization: tags.imageStabilization ?? undefined,
        JPEGQuality: tags.jpegQuality ?? undefined,
        LUT1Name: tags.lut1Name ?? undefined,
        LUT1Opacity: tags.lut1Opacity ?? undefined,
        LUT2Name: tags.lut2Name ?? undefined,
        LUT2Opacity: tags.lut2Opacity ?? undefined,
        MeteringMode: tags.meteringMode ?? undefined,
        MonochromeGrainEffect: tags.monochromeGrainEffect ?? undefined,
        MPImageLength: tags.mpImageLength ?? undefined,
        NoiseReduction: tags.noiseReduction ?? undefined,
        NumberOfImages: tags.numberOfImages ?? undefined,
        PictureEffect: tags.pictureEffect ?? undefined,
        PictureMode: tags.pictureMode ?? undefined,
        PictureStyle: tags.pictureStyle ?? undefined,
        PitchAngle: tags.pitchAngle ?? undefined,
        Quality: tags.quality ?? undefined,
        ReleaseMode: tags.releaseMode ?? undefined,
        RollAngle: tags.rollAngle ?? undefined,
        Saturation: tags.saturation ?? undefined,
        SceneCaptureType: tags.sceneCaptureType ?? undefined,
        SensitivityType: tags.sensitivityType ?? undefined,
        ShadowTone: tags.shadowTone ?? undefined,
        Shadows: tags.shadows ?? undefined,
        Sharpness: tags.sharpness ?? undefined,
        SharpnessRange: tags.sharpnessRange ?? undefined,
        ShootingMode: tags.shootingMode ?? undefined,
        Shutter: tags.shutter ?? undefined,
        ShutterType: tags.shutterType ?? undefined,
        Software: tags.software ?? undefined,
        UserComment: tags.userComment ?? undefined,
        WBShiftAB: tags.wbShiftAB ?? undefined,
        WBShiftGM: tags.wbShiftGM ?? undefined,
        WhiteBalance: tags.whiteBalance ?? undefined,
        WhiteBalanceFineTune: tags.whiteBalanceFineTune ?? undefined,
      };

      await exiftool.write(output, tagsToWrite as any, {
